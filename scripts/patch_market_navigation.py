...
nav = '''<nav class="sidebar-nav">
    <a class="active" href="index.html"><span class="nav-ico">⌁</span>Sverige Top 20</a>
    <a href="nasdaq.html"><span class="nav-ico">◈</span>NASDAQ Top 50</a>
...
# Swedish page copy now explicitly names its market universe.
html = re.sub(r'<div class="eyebrow">.*?</div>', '<div class="eyebrow">SWEDISH HIGH-RISK EQUITIES</div>', html, count=1)
